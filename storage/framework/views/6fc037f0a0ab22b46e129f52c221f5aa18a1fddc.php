...
<div class="col-md-12 grid-margin">
    <div class="card">
        <div class="card-body">
            ...
            <form  method="POST" action="<?php echo e(route('create_user')); ?>" class="form-sample">
            <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" name="first_name" value="<?php echo e(old('first_name')); ?>" required autocomplete="off" autofocus />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="username" type="text" autocomplete="off" class="form-control <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('matricule')); ?>" required autocomplete="off" autofocus />
...
unset($__errorArgs, $__bag); ?>" name="solde" value="<?php echo e(old('solde')); ?>" required autocomplete="off" autofocus />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                            <label class="col-sm-3 col-form-label"  style="padding-top:10px"><?php echo e(__('Sexe')); ?></label>
                            <div class="col-sm-4">
...
unset($__errorArgs, $__bag); ?>" name="date_embauche" value="<?php echo e(old('date_embauche')); ?>" required autocomplete="off" autofocus />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><?php echo e(__('Mot de Passe')); ?></label>
                                <div class="col-sm-9">
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-6">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label" style="padding-top: 0px;"><?php echo e(__('Confirmer le Mot de Passe')); ?></label>
                                <div class="col-sm-9">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AGENT\Documents\MyOpla\resources\views/admin/create_user.blade.php ENDPATH**/ ?>